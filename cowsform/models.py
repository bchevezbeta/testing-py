...
class NamePlate(models.Model):
    ...
    co_customer_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    co_customer_cash = models.CharField(max_length=200, blank=True, verbose_name='Customer Cash')
    co_bc_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    co_bc_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='BC Bonus Cash')
    co_auto_show_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    co_auto_show_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='Auto Show Bonus Cash')

    fo_apr_and_term_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    fo_apr_and_term = models.CharField(max_length=200, blank=True, verbose_name='APR & Term')
    fo_bc_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    fo_bc_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='BC Bonus Cash')
    fo_auto_show_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    fo_auto_show_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='Auto Show Bonus Cash')

    ccfo_customer_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Program ID')
    ccfo_customer_cash = models.CharField(max_length=200, blank=True, verbose_name='Customer Cash')
    ccfo_cc_bc_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Program ID')
    ccfo_cc_bc_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='Bonus Cash')
    ccfo_apr_and_term_program_id = models.CharField(max_length=200, blank=True, verbose_name='Program ID')
    ccfo_apr_and_term = models.CharField(max_length=200, blank=True, verbose_name='APR & Term')
    ccfo_aat_bc_bonus_cash_program_id = models.CharField(max_length=200, blank=True, verbose_name='Program ID')
    ccfo_aat_bc_bonus_cash = models.CharField(max_length=200, blank=True, verbose_name='Bonus Cash')

    lo_lease_payment_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    lo_lease_payment = models.CharField(max_length=200, blank=True, verbose_name='Lease Payment')
    lo_term_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
    lo_term = models.CharField(max_length=200, blank=True, verbose_name='Term')
    lo_due_at_signing_program_id = models.CharField(max_length=200, blank=True, verbose_name='Programe ID')
